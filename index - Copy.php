...
$strSku = $arrSku["sku"];
?>
<div style="text-align:center"><h1>Export File</h1></div>
...
if($intRows > 0)
{
    ...
    <tr>
        ...
        <th style="border:1px solid #CCC;"><?php echo "Created At";?></th>
    </tr>
	<?php
	while($arrResult = mysql_fetch_assoc($objQuery))
	{
		...
		<tr>
            ...
            <td style="border:1px solid #CCC;"><a style="color:#000;" href="mailto:<?php if($arrResult["shipping_email"] != ""){echo $arrResult["shipping_email"];}else{$arrResult["customer_email"];}?>"><?php if($arrResult["shipping_email"] != ""){echo $arrResult["shipping_email"];}else{$arrResult["customer_email"];}?></a></td>
...
{
	?>
	<div style="text-align:center;border:1px solid #CCC;">No Record Found</div>
	<?php
}	
	?>
    <br />
	<input type="button" name="submit" value="Export All Cage Product" onclick="window.open('<?php echo $exportFileUrl."?id=".$urlId;?>');"/>
